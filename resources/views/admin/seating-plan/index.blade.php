...
@section('content-header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                <h1 class="m-0">Seating Plan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Seating Plan</li>
                </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="row">
        ...
        <div class="container-fluid">
            <div class="text-right mb-3">
                <a class="btn btn-success btn-sm" href="{{route('create-seating-plan')}}" role="button"><i class="fas fa-plus mr-2"></i> Add New</a>
            </div>
            {{-- <table class="table table-border">
                <caption>List of Seating Plan</caption>
                <thead>
                  <tr>
                    <th scope="col">ID</th>
